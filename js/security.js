...
//		console.log(key);
	...
	/**
	 * 通过ajax 同步请求，来获取key的参数 modulus,exponent；
	 * 通过encodeURIComponent(String str) 对中文文本转换成URL编码
	 * 通过RSAUtils.encryptedString(Object key, String str) 对URL编码后的文本进行加密
	 * @return {Object} key
	 * @param {string} serverUrl
	 * 
	 */
	RSAUtils.getKeyFromServer=function(postUrl,handleSucc) {
		sendPost(postUrl,{},function (xhr,type,errThr) {
			mui.confirm("服务器异常,请稍后重试","",['退出'],function (e) {
				if (e.index==0) {
					plus.runtime.quit();
				}
			});
...
////				var exp = data.data.exponent;
////				keyObj = RSAUtils.getKeyPair(exp, "", mod);
////				console.log("mod:" +mod+" exp:"+exp);
//			},
